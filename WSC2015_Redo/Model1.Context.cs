...
namespace WSC2015_Redo
{
    ...
    public partial class WSC2015_RedoEntities : DbContext
    {
        public WSC2015_RedoEntities()
            : base("name=WSC2015_RedoEntities")
        {
        }
        ...
        public virtual DbSet<Rank_View> Rank_View { get; set; }
        public virtual DbSet<Sponsor_View> Sponsor_View { get; set; }
        public virtual DbSet<Volunteer_View> Volunteer_View { get; set; }
        public virtual DbSet<Runner_View> Runner_View { get; set; }
    }
}
